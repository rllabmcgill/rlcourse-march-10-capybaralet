"""
Since I use the same data for all experiments, I make it once using this script, before I actually launch the jobs which train the MLPs.
...
if subprocess.check_output("hostname").startswith("hades"):
    ...
    job_prefix += 'sbatch --mem=4000 -t 0-' + str(nhours)
